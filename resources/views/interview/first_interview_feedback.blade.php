        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('recruitments.index') }}">Tất cả tuyển dụng</a></li>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form class="form-horizontal" method="post" action="{{ route('first_interview_invitations.update', $first_interview_invitation->id) }}" name="create_first_interview_feedback" id="create_first_interview_feedback" novalidate="novalidate">
                            @method('PATCH')
                            {{ csrf_field() }}
                            <div class="card-body">
                                <input type="hidden" name="recruitment_candidate_id" id="recruitment_candidate_id" value="{{$first_interview_invitation->recruitment_candidate_id}}">
                                <div class="row">
                                    <div class="col-6">
