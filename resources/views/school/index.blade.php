        ...
        <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                @can('import', App\Models\School::class)
                    <button type="button" class="btn btn-success float-right" data-toggle="modal" data-target="#import_schools">
                ...
                <!-- modal -->
                <form class="form-horizontal" method="post" action="{{ route('schools.import') }}" enctype="multipart/form-data" name="import-schools" id="import-schools">
                    {{ csrf_field() }}
                    <div class="modal fade" id="import_schools">
