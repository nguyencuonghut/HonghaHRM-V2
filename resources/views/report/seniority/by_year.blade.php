...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Báo cáo thâm niên {{$year}} năm</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ route('seniority_reports.index') }}">Tất cả</a></li>
            <li class="breadcrumb-item active">{{$year}} năm</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
                        ...
                        <div class="col-3">
                            <div class="input-group">
                                <select name="year" id="year" data-placeholder="Chọn" class="form-control select2" style="width: 20%;">
                                    <option value="5" @if(5 == $year) selected="selected" @endif>5</option>
                                    <option value="10" @if(10 == $year) selected="selected" @endif>10</option>
                                    <option value="15" @if(15 == $year) selected="selected" @endif>15</option>
                                    <option value="20" @if(20 == $year) selected="selected" @endif>20</option>
                                    <option value="25" @if(25 == $year) selected="selected" @endif>25</option>
                                    <option value="30" @if(30 == $year) selected="selected" @endif>30</option>
                                </select>
                                &nbsp;
