...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Báo cáo sinh nhật tháng {{$month}}</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ route('home') }}">Trang chủ</a></li>
            <li class="breadcrumb-item active">Báo cáo sinh nhật tháng {{$month}}</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
                        ...
                        <div class="col-4">
                            <div class="control-group">
                                ...
                                <div class="input-group date" id="month" data-target-input="nearest">
                                    <input type="text" id="month" name="month" class="form-control datetimepicker-input" value="{{$month}}" data-target="#month"/>
