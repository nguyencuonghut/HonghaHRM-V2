      ...
      <div class="row">
        <div class="col-12">
            <div class="card">
              <!-- /.card-header -->
              <div class="card-body">
                @can('import', App\Models\Kpi::class)
                    <button type="button" class="btn btn-success float-right" data-toggle="modal" data-target="#import_kpis">
                ...
                <!-- modal -->
                <form class="form-horizontal" method="post" action="{{ route('kpis.import') }}" enctype="multipart/form-data" name="import-kpis" id="import-kpis">
                    {{ csrf_field() }}
                    <div class="modal fade" id="import_kpis">
